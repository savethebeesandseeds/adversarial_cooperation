...
This is how to play Texas Hold-em Poker without showing your cards to reclaim a win, 
...
\begin{enumerate}
    ...
    \item prevent parties from associating 
    ...
    have people decide on holding or betting, so, it's impractical to the game rules to guarantee 
    no two parties are joining efforts. 
    \item hold or bet
    \item hold or bet
    \item hold or bet
    \item Assign values by the Poker rule convention to each commitment
    \item Introduce Compute the value of the final cards. on homophobic space with the cards in the table. 
