...
It is expected of a hash function, where n is the output size, that finding a pre-image requires $O(2^n)$ hash computations and producing a collision $O(2^{n/2})$ 
hash computations. It's much easier to find a collision, this is know as the birthday attack. 
