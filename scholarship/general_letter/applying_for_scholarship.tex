% Compile with: latexmk -cd -pdf -interaction=nonstopmode -outdir=. applying_for_scholarship.tex
...
\begin{abstract}
This study investigates the role of information theory in designing cryptographic protocols that establish trust in adversarial settings. 
By leveraging secure multi-party computations, things like differential privacy and zero-knowledge proofs; the research aims to build 
an \textit{open-source} software library demonstrating cooperation results.
\end{abstract}

\section{Introduction}
If permission is granted, in collaboration with the \textit{Chinese Academy of Sciences}, 
develop cryptographic frameworks that enhance cooperation in structured interactions. 
Implement information-secure and verifiable encryption protocols, aimed at securing game-theoretic coordination, and privacy-preserving decision-making.
...
---Combining these secure units enable broad collaborative problem-solving that I believe are the key to adversarial cooperation.
...
\section{Funding Request and Justification}
I humbly request the kind support of the esteemed members of the Chinese Embassy in my application process. 
As outlined in the China Scholarship Council guidelines (www.campuschina.org): 

\begin{tcolorbox}[colback=gray!5!white, colframe=gray!10!white, sharp corners]
    \textcolor{blue}{\textit{``Applicants shall obtain approval and recommendation from the host country before applying."}}
\end{tcolorbox}

Universities in Colombia currently lack research programs in this area. I have been diligently studying the Chinese language for several years, 
...
\vspace{5pt}
\begin{tabular}{rl}
    \textcolor{blue}{\small\textit{Wuhan University}} & {\small Master’s in Electrical Engineering}\\
    \textcolor{blue}{\small\textit{Hubei University}} & {\small PhD in Applied Mathematics (Cryptography)}\\
    \textcolor{blue}{\small\textit{Chang'an University}} & {\small Master’s in Cryptography Theory}\\
    \textcolor{blue}{\small\textit{Tsinghua University}} & {\small Master’s in Advanced Computing}
\end{tabular}
