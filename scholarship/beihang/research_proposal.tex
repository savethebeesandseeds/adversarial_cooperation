% Compile with: latexmk -cd -pdf -interaction=nonstopmode -outdir=. research_proposal.tex
...
By leveraging secure multi-party computations; the research aims to build 
an \textit{open-source} software library demonstrating results.
\end{abstract}

\section{Introduction}
If Scholarship funding for this study is approved by the \textit{Chinese Ministry of Industry and Information Technology}, 
We will develop cryptographic frameworks with the promise of enhancing communication for cooperation in structured interactions. 
...
---Combining these secure units enable broad collaborative problem-solving that are believed are the key to adversarial cooperation.
...
I humbly request the kind support of the esteemed members of the \textit{Beihang University} in my application process. 
