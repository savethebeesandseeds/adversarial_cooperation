...
- `code/src/primitives/`: reusable, narrowly scoped cryptographic wrappers.
- `code/src/circuits/`: dependency-free Boolean circuit representation and
  relation-specific builders.
- `code/src/protocols/`: participant-local protocol state machines.
- `code/src/hash_functions/`: fixed public teaching examples for BLAKE2b-256.
- `code/src/two_oracles_play_rock_paper_scissors/`: RPS teaching driver.
- `code/src/tic_tac_toe_without_revealing_the_strategy/`: public-policy checker
  teaching driver and separate commitment-measurement driver.
- `code/src/poker_without_revealing_the_cards/`: earlier centralized poker demo.
...
- Binary: `.local/build/poker_without_revealing_the_cards/poker_demo`
- RPS binary: `.local/build/two_oracles_play_rock_paper_scissors/rps_demo`
- Hash binary: `.local/build/hash_functions/hash_demo`
- Tic-Tac-Toe binary: `.local/build/tic_tac_toe_without_revealing_the_strategy/ttt_demo`
- Tic-Tac-Toe Bind measurement binary:
  `.local/build/tic_tac_toe_without_revealing_the_strategy/ttt_bind_demo`
- Temp objects: `.local/scratch/poker_without_revealing_the_cards/`
- RPS temp objects: `.local/scratch/two_oracles_play_rock_paper_scissors/`
- Hash temp objects: `.local/scratch/hash_functions/`
- Tic-Tac-Toe temp objects: `.local/scratch/tic_tac_toe_without_revealing_the_strategy/`
