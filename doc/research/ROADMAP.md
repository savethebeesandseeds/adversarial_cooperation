...
doc/adversarial_cooperation_short.tex; the existing
doc/adversarial_cooperation.tex remains the companion entry.
...
phases below. doc/research/EDITION_MAP.md connects the two sources for each chapter
...
`doc/research/plans/commitment-and-rps-vertical-slice.md` and is limited to:
...
`doc/research/plans/trust-establishment-model-repair.md`. It is deliberately
manuscript-only:
