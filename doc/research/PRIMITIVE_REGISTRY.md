...
- Public interface: `code/include/ac/hash.h`.
- Implementation: `code/src/primitives/hash.c`.
...
- Teaching appendix: `doc/content/aprendix/hash_functions/`.
- Fixed public demonstration: `code/src/hash_functions/hash_demo.c`.
- Deterministic vectors: `code/tests/vectors/hash-foundations-v1.md`.
- Wrapper tests: `code/tests/test_hash.c`.
...
- Chapter: `doc/content/two_oracles_play_rock–paper–scissors/`.
- Public interface: `code/include/ac/commitment.h`.
- Implementation: `code/src/primitives/commitment.c`.
- Deterministic vector: `code/tests/vectors/commitment-v1.md`.
- Tests: `code/tests/test_commitment.c`.
...
- Chapter:
  `doc/content/tic_tac_toe_without_revealing_the_strategy/`.
- Profile interface: `code/include/ac/ttt_bind.h`.
- Profile wrapper and symbolic cost model: `code/src/protocols/ttt_bind.c`.
- Warning-bearing profile demo:
  `code/src/tic_tac_toe_without_revealing_the_strategy/ttt_bind_demo.c`.
- Deterministic vector: `code/tests/vectors/tic-tac-toe-bind-v1.txt`.
- Tests: `code/tests/test_ttt_bind.c`.
...
above; see `doc/research/BIBLIOGRAPHY_QUEUE.md`.
