#!/usr/bin/env bash
# compile_latex.sh – Compile a LaTeX document with optional spell-checking
# ---------------------------------------------------------------
...
# ─────────────────────────  Target document  ───────────────────
tex_file=${1:-"$ROOT_DIR/doc/adversarial_cooperation.tex"}
...
# ─────────────────────────  Compile (colourised)  ───────────────
outdir=${LATEX_OUTDIR:-"$ROOT_DIR/.local/build/pdf"}
